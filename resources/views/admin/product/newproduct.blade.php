        ...
        <div class="main-card mb-4 card">
            <div class="card-body">
                ...
                <form action="{{ url('addProduct') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Product Submit</button>
                </form>
            </div>
        </div>
    </div>
